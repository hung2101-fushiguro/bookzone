...
public class Comment {
    ...
    public Comment(int commentId, int bookId, int accessoryId, int userId, String userName, String content, int rating, Timestamp createdAt, Integer parentCommentId) {
        this.commentId = commentId;
        this.bookId = bookId;
